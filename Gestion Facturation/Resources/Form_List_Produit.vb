...
Public Class Form_List_Produit
    Dim hn As OleDb.OleDbDataReader
    Dim bs As New BindingSource
    Private Sub Form_List_Produit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ft.Open()
        Dim x As OleDb.OleDbDataReader
        Dim y As New OleDbDataAdapter("Select * from produit", ft)
        ...
        'Dim cmd As New OleDb.OleDbCommand("select * from Produit", ft)
